 ...
 * @author apptech
 */
public class Edit_Vender extends JFrame{
   ...
   lblName=new JLabel("Distributer Name");
       ...
       cmbFirm.addItemListener(new ItemListener()
        {
            ...
            try
               {
              rs=Sells_Database.getVenderDetails(FirmName);
               if(rs.next())
               {
       ...
       btnSave.addActionListener(new ActionListener()
       {
           ...
           public void actionPerformed(ActionEvent e)
           {
               ...
               else
               {
                ...
                Sells_Database.updateVender(name, dob, mobile, mail, area, state, nationality,Firm_Name);
