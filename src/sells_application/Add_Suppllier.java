 ...
 * @author apptech
 */
public class Add_Suppllier extends JFrame
{
    JLabel lblSRF,lblName,lblGender,lblFirm,lblDOB,lbldate,lblMobile,lblMail,lblArea,lblState,lblNationlity,lblWelcomeText;
   ...
   lblSRF.setFont(f);
   lblSRF.setForeground(Color.green);
   ...
   lblName=new JLabel("Distributor Name");
         ...
         btnRegister.addActionListener(new ActionListener()
        {
             ...
             if(txtName.getText().isEmpty() || txtDOB.getText().isEmpty()|| txtMobile.getText().isEmpty()|| txtMail.getText().isEmpty()|| txtArea.getText().isEmpty()|| txtNationlity.getText().isEmpty())
            {
            ...
            else
             {
                ...
                Sells_Database.Add_Supplier(Firm_Name, Name, Gender, DOB, Mobile, Email, Area, State, Nation);
                 }
                 else
                 {
                                 String Firm_Name=txtFirm.getText().trim();
                ...
                Sells_Database.Add_Supplier(Firm_Name, Name, Gender, DOB, Mobile, Email, Area, Name, Nation);
                 }
                txtFirm.setText("");
                txtName.setText("");
                txtDOB.setText("");
