...
public class View_Products 
{
 ...
 ResultSet rs;
 JPanel panel;
String Product_Name,Product_Code,Price,Quantity,mfgDate,expDate,category,Receve_From,Firm_Name,s;
String[] columnNames={"Product Name","Product Code","Price","Qantity","MfgDate","ExpDate","Category","Receive From","Firm Name"};
public View_Products()
{
         frame = new JFrame("Product Report");
...
//Data Retrival Code
 try {
        ...
        rs=Sells_Database.Products_Report();
while (rs.next()) 
            {
                ...
                mfgDate = rs.getString("Mgf_Date");
                expDate = rs.getString("Exp_Date");
                category= rs.getString("Product_Category");
                Firm_Name= rs.getString("Firm_Name");
                Receve_From= rs.getString("Receved_From");
                

                model.addRow(new Object[]{Product_Name,Product_Code,Price,Quantity,mfgDate,expDate,category,Receve_From,Firm_Name});
